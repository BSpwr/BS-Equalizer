#ifndef CLA_SHARED_CPU2_H_
#define CLA_SHARED_CPU2_H_
...
extern float output_sample_right;           //Result
extern float input_sample_right;           //Holds the input argument to the task
